  ...
  return (
    <View className="gap-1 flex-1">
      <Pressable
        ...
        className={`border rounded-xl px-3 flex-row items-center justify-between bg-white ${error ? 'border-error' : 'border-neutral-200'}`}
  ...
  return (
    <View className="gap-1">
      ...
      <View className="flex-row gap-3 items-start">
        ...
        />
        <Text className="text-neutral-400 text-base" style={{ paddingTop: 10 }}>—</Text>
        <TimePickerInput
          value={endTime}
