    ...
    >
      ...
      {onSettle && (
        <TouchableOpacity
          ...
          disabled={isSettling}
          activeOpacity={0.8}
          className="mx-4 mb-4 flex-row items-center justify-center gap-2 rounded-xl py-2.5 border border-neutral-200 dark:border-surface-600 active:bg-neutral-50 dark:active:bg-surface-700"
