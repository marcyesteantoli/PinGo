  ...
  return (
    <View className="bg-white dark:bg-surface-800 rounded-2xl p-5 gap-4" style={{ elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8 }}>
      ...
      <View className="items-center py-2">
        <Text className="text-xs text-neutral-400 dark:text-neutral-500 mb-1">Total gastado</Text>
      ...
      <View className="flex-row border-t border-neutral-100 dark:border-surface-700 pt-4 gap-4">
        <View className="flex-1 items-center">
          <Text className="text-xs text-neutral-400 dark:text-neutral-500 mb-1">Mi parte</Text>
        ...
        <View className="flex-1 items-center">
          <Text className="text-xs text-neutral-400 dark:text-neutral-500 mb-1">Mi balance</Text>
          ...
          <Text className={`text-xs mt-0.5 ${isPositive ? 'text-green-500 dark:text-green-400' : isNegative ? 'text-red-400 dark:text-red-400' : 'text-neutral-400 dark:text-neutral-500'}`}>
