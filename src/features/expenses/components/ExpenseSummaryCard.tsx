  ...
  return (
    <View className="bg-white dark:bg-surface-800 rounded-2xl p-5 gap-4" style={{ elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8 }}>
      <View className="flex-row items-center justify-between">
        ...
        <Text className="text-xs text-neutral-500 dark:text-neutral-400">{expenses.length} gasto{expenses.length !== 1 ? 's' : ''}</Text>
      </View>

      <View className="items-center py-2">
        <Text className="text-[13px] text-neutral-500 dark:text-neutral-400 mb-1">Total gastado</Text>
      ...
      <View className="flex-row border-t border-neutral-100 dark:border-surface-700 pt-4 gap-4">
        <View className="flex-1 items-center">
          <Text className="text-[13px] text-neutral-500 dark:text-neutral-400 mb-1">Mi parte</Text>
        ...
        <View className="flex-1 items-center">
          <Text className="text-[13px] text-neutral-500 dark:text-neutral-400 mb-1">Mi balance</Text>
