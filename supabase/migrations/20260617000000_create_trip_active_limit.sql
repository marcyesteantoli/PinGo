-- Enforce the free-plan active trips limit server-side (defense in depth; client also checks).
-- Same signature as 20260602000001_fix_create_trip_conflict.sql to avoid PGRST203 overload conflicts.
